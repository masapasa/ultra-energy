    ...
    async function getTodayEnergy() {
      ...
      function createNotification(energyDifference: number) {
        ...
        navigator.serviceWorker.ready.then(function(registration) {
          registration.showNotification(`Uh-oh! 😦 You have exceeded your energy limit!`, {
            body: `Limit exceeded by ${energyDifference} kWh. How about trying to turn off some appliances to save money and not harm the environment? 🌏💸`
            });
        });
        

        // return new Notification(`Uh-oh! 😦 You have exceeded your energy limit!`, {
        //   body: 'How about trying to turn off some appliances to save money and not harm the environment? 🌏💸'
        // })
      }
